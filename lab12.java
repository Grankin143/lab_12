...
public class lab12 {
    public static void main(String[] args) {
        ...
        String[] platforms = new String[10], import1 = new String[10], export = new String[10];
        ...
        if(f.equals("1")){
            ...
            if(f.equals("1")){
                ...
                while(f.equals("1")){
                    ...
                    i++;
                    System.out.println("Добавить ещё лекарство ?(1 - да, 0 - нет)");
                    f = in.nextLine();
                }
                numOfMeds1 = i;
                ...
                while(f.equals("1")){
                    ...
                    {
                        d++;
                        naz_world1[d] = in.nextLine();
                    } while (!naz_world1[d].equals(""));
                    proz1[i] = new Proizvoditel(mass1, nameLek1, price1, amount1, date, naz_world1);
                    i++;
                ...
                numOfWorlds1 = i;
                apteka[0] = new Apteka(name1, num1, numOfMeds1, lek1, numOfProzs1, proz1, numOfWorlds1, naz_world11);
            }
            else if(f.equals("2")){
                System.out.println("Введите название аптеки: ");
                name1 = in.nextLine();
        ...
        while(f.equals("9") == false){
            ...
            if(f.equals("1")){
                ...
                naz_world1[0] = "aaa";
                proz1[0] = new Proizvoditel("proz", "proz", 1, 1, date, naz_world1);
                import1[0] = "bbb";
                naz_world1[0] = "zzz";
                naz_world1[0] = new Naz_world("naz_world", "naz_world", 2, 2, import1, naz_world);
